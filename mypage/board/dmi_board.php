    ...
    if (isset($_POST["mode"]) && $_POST["mode"] === "delete") {
	   ...
	   ";
        ...
        if ($upfile_name && !$upfile_error) { // 업로드가 잘되었는지 판단
            ...
            $copied_file_name = $new_file_name . "." . $file_ext; // 2021_04_27_09_30_20_memo.sql
            $uploaded_file = $upload_dir . $copied_file_name; // ./data/2021_04_27_09_30_20_memo.sql 다 합친것
