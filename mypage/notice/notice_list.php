...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css"
		      href="http://<?= $_SERVER['HTTP_HOST'] ?>/mypage/notice/css/notice.css">
		<script src="http://<?= $_SERVER['HTTP_HOST'] ?>/mypage/notice/js/notice.js"></script>
	...
	<body>
        ...
        <?php include_once $_SERVER['DOCUMENT_ROOT']."/mypage/db/db_connect.php";
            include_once $_SERVER['DOCUMENT_ROOT']."/mypage/db/create_table.php";
